...
user = os.getlogin()
template = 'C:/Users/%s/Documents/Follow-up Service/Letters and Letter Maker/Ascent-Dental-Letter-Template.docx' % (user)

document = MailMerge(template)

root.title('Letters/Ascent-Dental-Letter-Template.docx')
root.geometry('+50+50')
...
TAB2 = ttk.Frame(TAB_CONTROL, width=300, height=100)

TAB_CONTROL.add(TAB2, text='Procedure Options')
...
Title = Label(TAB1, text='Follow-up Automator')
Title.pack()


BlankSpacer1 = Label(TAB1, text='')
BlankSpacer1.pack()

NameLabel = Label(TAB1,text='Patient Name')
NameLabel.pack()

Name = Entry(TAB1)
Name.pack()

OfficeLabel = Label(TAB1,text='Which office did the patient visit?')
OfficeLabel.pack()

OfficeDropdown = OptionMenu(TAB1, OfficeVar, *OFFICES)
OfficeDropdown.pack()

DateOfVisitLabel = Label(TAB1,text='When was the patients last visit?')
DateOfVisitLabel.pack()

DateOfVisit = DateEntry(TAB1)
DateOfVisit.pack()

NextVisitLabel = Label(TAB1, text='When is the patients next visit?')
NextVisitLabel.pack()

NextVisit = DateEntry(TAB1)
NextVisit.pack()
...
PatientSettings = Label(TAB2, text='Treatment Options')
PatientSettings.pack()

WaitAndWatch = Checkbutton(TAB2, text='Wait and Watch', variable=WaitAndWatchVar)
WaitAndWatch.pack()

WaitAndWatchToothLabel = Label(TAB2, text='Tooth #?') 
WaitAndWatchToothLabel.pack()

WaitAndWatchToothNumber = Spinbox(TAB2, from_=0, to=32, width=4)
WaitAndWatchToothNumber.pack()

BlankSpacer7 = Label(TAB2, text='')
BlankSpacer7.pack()

spacer1 = Label(TAB2, text='====')
spacer1.pack()

RestorativeTreatment = Checkbutton(TAB2,  text='Restorative Treatment', variable=RestorativeTreatmentVar)
RestorativeTreatment.pack()

RestorativeTreatmentLabel = Label(TAB2, text='Tooth #?')
RestorativeTreatmentLabel.pack()

RestorativeTreatmentToothNumber = Spinbox(TAB2, from_=0, to=32, width=4)
...
CrownTreatment = Checkbutton(TAB2, text='Crown Treatment', variable=CrownTreatmentVar)
CrownTreatment.pack()

CrownTreatmentLabel = Label(TAB2, text='Tooth #?')
CrownTreatmentLabel.pack()

spacer3 = Label(TAB2, text='====')
spacer3.pack()

CrownTreatmentNumber = Spinbox(TAB2, from_=0, to=32, width=4)
CrownTreatmentNumber.pack()

spacer6 = Label(TAB2, text='====')
spacer6.pack()

RootCanalTreatment = Checkbutton(TAB2,  text='Root Canal Treatment', variable=RootCanalTreatmentVar)
RootCanalTreatment.pack()

spacer8 = Label(TAB2, text='====')
spacer8.pack()

RootCanalTreatmentNumber = Spinbox(TAB2, from_=0, to=32, width=4)
RootCanalTreatmentNumber.pack()

spacer5 = Label(TAB2, text='====')
spacer5.pack()

WisdomTeeth = Checkbutton(TAB2,  text='Wisdom Teeth', variable=WisdomTeethVar)
WisdomTeeth.pack()

spacer5 = Label(TAB2, text='====')
spacer5.pack()

WisdomTeethNumber = Spinbox(TAB2, from_=0, to=32, width=4)
WisdomTeethNumber.pack()

spacer11 = Label(TAB2, text='====')
spacer11.pack()

WaitAndWatchOnWisdomTeeth = Checkbutton(TAB2,  text='Wait and Watch on Wisdom Teeth', variable=WaitAndWatchOnWisdomTeethVar)
WaitAndWatchOnWisdomTeeth.pack()

spacer7 = Label(TAB2, text='====')
spacer7.pack()

WaitAndWatchOnWisdomTeethNumber = Spinbox(TAB2, from_=0, to=32, width=4)
WaitAndWatchOnWisdomTeethNumber.pack()

spacer10 = Label(TAB2, text='====')
spacer10.pack()

ExtractingTreatment = Checkbutton(TAB2,  text='Extraction Treatment', variable=ExtractingTreatmentVar)
ExtractingTreatment.pack()

spacer9 = Label(TAB2, text='====')
spacer9.pack()

ExtractingTreatmentNumber = Spinbox(TAB2, from_=0, to=32, width=4)
ExtractingTreatmentNumber.pack()

BlankSpacer4 = Label(TAB2, text='')
BlankSpacer4.pack()
...
-Special needs patient care, hospital visits and home visits
    ...
    print(PaymenTAB2tionsPara)
    document.merge(PaymenTAB2tions=PaymenTAB2tionsPara)    
    print(FinalPara)
...
BlankSpacer5 = Label(TAB1, text='')
BlankSpacer5.pack()

MainSubmit = Button(TAB1, text='Submit', fg='Green', command=submit)
MainSubmit.pack()

BlankSpacer6 = Label(TAB1, text='')
BlankSpacer6.pack()

DoubleClick = Label(TAB1,text='*You may have to double click submit!*', fg='red')
DoubleClick.pack()

CloseApp = Label(TAB1,text='*You must close the app in order to open a letter*', fg='red')
CloseApp.pack()
